...
use App\Orchid\Screens\Examples\ExampleCardsScreenTest;
...
use App\Orchid\Screens\Tabelas;
...
Route::screen('example-cards', ExampleCardsScreenTest::class)->name('platform.example.cards');
